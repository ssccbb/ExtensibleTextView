...
/**
 * Created by sung on 2018/1/4.
 */
public class ExtensibleTextView extends LinearLayout implements View.OnClickListener {
    ...
    public ExtensibleTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public ExtensibleTextView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void setOrientation(int orientation) {
        if (LinearLayout.HORIZONTAL == orientation) {
            throw new IllegalArgumentException("ExtensibleTextView only supports Vertical Orientation.");
        }
    ...
    private void init(AttributeSet attrs) {
        ...
        TypedArray typedArray = getContext().obtainStyledAttributes(attrs, R.styleable.ExtensibleTextView);
        mMaxCollapsedLines = typedArray.getInt(R.styleable.ExtensibleTextView_maxCollapsedLines, MAX_COLLAPSED_LINES);
        mAnimationDuration = typedArray.getInt(R.styleable.ExtensibleTextView_animDuration, DEFAULT_ANIM_DURATION);
//        mExpandDrawable = typedArray.getDrawable(R.styleable.ExtensibleTextView_expandDrawable);
//        mCollapseDrawable = typedArray.getDrawable(R.styleable.ExtensibleTextView_collapseDrawable);

        textCollapse = typedArray.getString(R.styleable.ExtensibleTextView_textCollapse);
        textExpand = typedArray.getString(R.styleable.ExtensibleTextView_textExpand);
...
//        }
        ...
        contentTextColor = typedArray.getColor(R.styleable.ExtensibleTextView_contentTextColor, ContextCompat.getColor(getContext(), R.color.colorBlack));
        contentTextSize = typedArray.getDimension(R.styleable.ExtensibleTextView_contentTextSize, 14);

        collapseExpandTextColor = typedArray.getColor(R.styleable.ExtensibleTextView_collapseExpandTextColor, ContextCompat.getColor(getContext(), android.R.color.holo_blue_dark));
        collapseExpandTextSize = typedArray.getDimension(R.styleable.ExtensibleTextView_collapseExpandTextSize, 14);

        grarity = typedArray.getInt(R.styleable.ExtensibleTextView_collapseExpandGrarity, Gravity.LEFT);
        drawableGrarity=typedArray.getInt(R.styleable.ExtensibleTextView_drawableGrarity, Gravity.RIGHT);
...
//        }
    ...
    public void setText( CharSequence text) {
        ...
        SpannableStringBuilder emojiString = Utils.getDynamicString(text.toString(), getContext(), false);
        //此处一定要设置setMovementMethod 否则clikcspan会失效
        mTvContent.setMovementMethod(LinkMovementMethod.getInstance());
        mTvContent.setText(emojiString);
